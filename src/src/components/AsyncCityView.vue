<template>
    <div class="flex flex-col flex-1 items-center">
        <!-- Banner -->
        <div v-if="route.query.preview" class="text-white p-4 w-full text-center">
            
            <p><i class="fa-solid fa-triangle-exclamation fa-beat-fade mr-1"></i>You are currently previewing this city, click the '+' icon to start tracking the city.</p>
        </div>
        <!-- Weather Overview -->
        <div class="flex flex-col items-center text-white py-12">
            <h1 class="text-4x1 mb-2">{{ route.params.city }}</h1>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                <h2 class="md-4">7 Day Forecast</h2>
        ...
        <div class="flex items-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-red-900 text-lg"
            @click="removeCity">
...
const getWeatherData = async () => {
    try {
        ...
        // converting the dt from the promise from seconds to milliseconds
